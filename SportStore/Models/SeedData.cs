        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product { Name = "Life Jacket", Description = "protective and fashionable", Category = "Watersports", Price = 48.95M },
                    ...
                    new Product { Name = "Bling-Bling-Bling", Description = "Gold-plated, diamond-studded King", Category = "Chess", Price = 1200 }
                    );
                context.SaveChanges();
            }
        }
